    ...
    return (
        <div className="postPage">
            ...
            {userInfo.id === postInfo.author._id && (
                <div className="edit">
                    <Link className='editBtn' to={`/edit/${postInfo._id}`}> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
